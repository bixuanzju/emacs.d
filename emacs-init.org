...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (bind-key [remap kill-whole-line] 'prelude-kill-whole-line)
...
#+begin_src emacs-lisp :tangle yes
  ...
  _a_, _<left>_                    _C-s_: ace-window-swap      _3_: split-window-right         _e_: rotate-frame-clockwise
  _s_, _<down>_                    _C-d_: ace-window-delete    _<_: toggle-split-direction     _y_: flip-frame vertically
  _d_, _<right>_                   ^   ^                       ^ ^                             _c_: flop-frame horizontally
