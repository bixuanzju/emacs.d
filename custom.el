...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zop-to-char zenburn-theme yaxception worf whitespace-cleanup-mode wgrep-ag volatile-highlights vlf visual-regexp-steroids utop use-package undo-tree tuareg swoop sml-mode smartparens smart-mode-line-powerline-theme skeletor reveal-in-finder request rainbow-mode rainbow-delimiters racket-mode quickrun popwin paredit pandoc-mode pallet ox-pandoc ov noflet mwim multi-term move-text merlin markdown-mode makey magit-gh-pulls m-buffer lua-mode log4e lispy lexbind-mode latex-extra key-chord js2-mode idris-mode idomenu ido-vertical-mode ido-ubiquitous ibuffer-projectile htmlize hindent highlight helm-projectile helm-descbinds helm-ag haskell-mode haskell-emacs gscholar-bibtex goto-chg gntp git-timemachine ggtags fullframe fold-this flycheck flx-ido expand-region exec-path-from-shell ensime elpy elisp-slime-nav ebib easy-kill dired+ dash-functional dash-at-point company-ghc company-coq cider chinese-fonts-setup cdlatex browse-kill-ring anzu ag)))
